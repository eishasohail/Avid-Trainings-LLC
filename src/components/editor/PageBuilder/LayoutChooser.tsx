    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[99999] flex items-center justify-center overflow-hidden">
        ...
        <motion.div
          ...
          className="relative w-full h-full flex flex-col items-center justify-between py-12 px-6 pointer-events-none"
        >
          {/* Header */}
                    ...
                    <AnimatePresence mode="popLayout">
                      {filteredLayouts.map((layout, index) => {
                        ...
                        return (
                          ...
                          >
                            <div className={`
                              relative w-[320px] h-[400px] bg-white rounded-[3rem] shadow-2xl overflow-hidden transition-all duration-500
                              ${isCenter 
                            ...
                            `}>
                              {/* Top Half */}
                              <div 
                                className="h-[220px] relative flex items-center justify-center"
                              ...
                              >
                                ...
                                <layout.icon 
                                  className={`w-16 h-16 relative z-10 transition-all duration-500 text-white ${
          ...
          {/* Bottom Controls */}
          <div className="w-full max-w-2xl flex flex-col items-center gap-8 pointer-events-auto">
