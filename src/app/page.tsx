...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafcfc] font-sans selection:bg-[#00685f]/15 overflow-x-hidden antialiased text-[#11221f]">
      {/* Refined Navigation */}
      <nav className={`fixed top-0 inset-x-0 z-[1000] transition-all duration-500 ${scrolled
            ...
            <div className="hidden lg:flex items-center gap-10">
              {[
                ...
                <button
                  ...
                  className={`text-[11px] font-black uppercase tracking-[0.25em] transition-all relative py-2 ${activeHash === `#${item.id}` ? 'text-[#00685f]' : 'text-[#6d7a77] hover:text-[#131b2e]'
                    }`}
                >
                  {item.name}
                  <div className={`absolute bottom-0 left-0 right-0 h-0.5 bg-[#00685f] rounded-full transition-transform duration-300 origin-left ${activeHash === `#${item.id}` ? 'scale-x-100' : 'scale-x-0'
                    }`} />
                </button>
              ))}
            </div>
      ...
      <main>
        <section id="home" className="relative pt-32 pb-16 px-6 min-h-screen flex flex-col items-center justify-center bg-[#fafcfc] overflow-hidden">
        ...
        {/* FEATURES */}
        <section id="features" className="py-20 md:py-32 px-8 bg-white relative overflow-hidden">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                {[
                  ...
                  <motion.div
                    ...
                    className={`p-8 bg-white/60 backdrop-blur-sm border border-[#00685f]/10 border-t-4 border-t-transparent ${feat.hoverBorder} rounded-[44px] space-y-8 transition-all hover:bg-white group relative overflow-hidden`}
                  >
                    {/* Inner card glow */}
        ...
        <section id="curriculum" className="py-16 md:py-24 px-6 bg-[#f7f9fb] relative overflow-hidden">
          {/* Background Glows */}
        ...
        {/* METHODOLOGY */}
        <section ref={journeyRef} id="methodology" className="py-20 md:py-32 px-10 bg-white relative overflow-hidden">
          {/* Floating Particles */}
          {[...Array(3)].map((_, i) => (
            <motion.div
              key={i}
              ...
              className={`absolute w-2 h-2 rounded-full bg-[#00685f]/40 ${i === 0 ? 'top-20 left-20' :
                i === 1 ? 'top-40 right-32' :
                  'bottom-20 left-1/3'
                }`}
            />
        ...
        {/* ENTERPRISE */}
        <section id="enterprise" className="py-16 md:py-24 px-10 bg-white relative overflow-hidden flex flex-col items-center">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false, margin: "-100px" }}
        ...
        {/* FINAL CTA */}
        <section className="py-20 md:py-32 px-10 bg-[#131b2e] relative overflow-hidden text-center flex flex-col items-center">
          <BubbleBackground
            interactive={true}
      ...
      <footer className="bg-[#fafcfc] py-16 md:py-24 px-8 border-t-2 border-[#00685f]/10 relative z-10">
